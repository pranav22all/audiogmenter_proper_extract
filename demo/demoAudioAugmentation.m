%% Train AlexNet on audio augmented signals
% This script shows how to train AlexNet using the samples generated from
% augmentation techniques applied to the raw audio signal and then mapped
% into spectrograms.
%
...
for fold = 1:5
    ...
    trainingData = {fullfile('audioAugmentedData',int2str(train(1))),...
        fullfile('audioAugmentedData',int2str(train(2))),....
        fullfile('audioAugmentedData',int2str(train(3))),....
        fullfile('audioAugmentedData',int2str(train(4)))};
