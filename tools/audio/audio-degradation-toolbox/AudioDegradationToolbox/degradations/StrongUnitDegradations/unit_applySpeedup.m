function degradation_config = unit_applySpeedup()
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Preset: applySpeedup
...
degradation_config(1).methodname = 'degradationUnit_applySpeedup';
degradation_config(1).parameter.changeInPercent = +5;
